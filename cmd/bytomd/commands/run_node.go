...
import (
	...
	"github.com/janotchain/janeta/node"
)
...
var runNodeCmd = &cobra.Command{
	Use:   "node",
	Short: "Run the janetad",
	RunE:  runNode,
}

func init() {
	runNodeCmd.Flags().String("prof_laddr", config.ProfListenAddress, "Use http to profile janetad programs")
