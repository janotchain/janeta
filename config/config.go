...
func DefaultP2PConfig() *P2PConfig {
	return &P2PConfig{
		ListenAddress:    "tcp://0.0.0.0:98632",
		SkipUPNP:         false,
		LANDiscover:      true,
		MaxNumPeers:      20,
		HandshakeTimeout: 30,
...
func DefaultDataDir() string {
	...
	case "darwin":
		...
		oldPath := filepath.Join(home, "Library", "janeta")
		newPath := filepath.Join(home, "Library", "Application Support", "janeta2")
		...
		return newPath
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "janeta2")
	default:
		return filepath.Join(home, ".janeta2")
	}
}
