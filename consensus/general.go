...
const (
	...
	InitJTASupply      = 169290721678579170 + 50000000000
	RewardThreshold    = 0.5
	...
	BCRPRequiredJTAAmount = uint64(100000000)
...
var JTADefinitionMap = map[string]interface{}{
	"name":        JTAAlias,
	"symbol":      JTAAlias,
	"decimals":    8,
	"description": `Janeta Official Issue`,
}
