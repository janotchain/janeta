...
var respErrFormatter = map[error]httperror.Info{
	ErrDefault: {500, "BTM000", "janeta API Error"},
	...
	vm.ErrRunLimitExceeded:   {400, "BTM770", "Run limit exceeded because the JTA Fee is insufficient"},
...
var errorFormatter = httperror.Formatter{
	Default:     httperror.Info{500, "BTM000", "janeta API Error"},
