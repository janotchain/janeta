janeta version 1.0.2 is now available from:

  https://github.com/janotchain/janeta/releases/tag/v1.0.2
...
You can operate according to the user manual.[(janeta User Manual)](URL 'https://janeta.io/wp-content/themes/freddo/images/wallet/janetaUsermanualV1.0_en.pdf')
