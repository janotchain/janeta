janeta version 1.0.4 is now available from:

  https://github.com/janotchain/janeta/releases/tag/v1.0.4
...
+ `PR #1115`
    - Add janetad command line parameter `--log_level` to set log level.
+ `PR #1118`
    - Add network access control api, include list-peers,connect-peer,disconnect-peer.
+ `PR #1124`
    - Fix a security bug that might attack janeta server.
+ `PR #1126`  
