janeta version 1.0.6 is now available from:

  https://github.com/janotchain/janeta/releases/tag/v1.0.6rc1
...
+ `PR #1316`
    - The default path of user data in the Mac environment is changed to ~/Library/Application Support/janeta.
+ `PR #1324`
...
+ `PR #1365`
    - Add build-chain-transactions API to support intelligent merged JTA UTXOs and sent out the chain transactions.
+ `PR #1378`
