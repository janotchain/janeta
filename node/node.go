...
import (
	...
	"github.com/janotchain/janeta/proposal/blockproposer"
	"github.com/prometheus/prometheus/util/flock"

	"github.com/janotchain/janeta/accesstoken"
	...
	cfg "github.com/janotchain/janeta/config"
	...
	janetaLog "github.com/janotchain/janeta/log"
	"github.com/janotchain/janeta/net/websocket"
	"github.com/janotchain/janeta/netsync"
	"github.com/janotchain/janeta/protocol"
	w "github.com/janotchain/janeta/wallet"
)
...
func NewNode(config *cfg.Config) *Node {
	...
	if profileHost != "" {
		// Profiling janetad programs.see (https://blog.golang.org/profiling-go-programs)
...
func initNodeConfig(config *cfg.Config) error {
	...
	if err := janetaLog.InitLogFile(config); err != nil {
