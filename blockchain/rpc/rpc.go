...
import (
	...
	"github.com/janotchain/janeta/net/http/reqid"
)

// janeta-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "janeta-Core-ID"
...
// A Client is a janeta RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("janeta; process=%s; buildtag=%s; blockchainID=%s",
