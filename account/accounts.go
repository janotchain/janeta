// Package account stores and tracks accounts within a janeta Core.
package account
...
import (
	...
	"github.com/janotchain/janeta/consensus/segwit"
	"github.com/janotchain/janeta/crypto"
...
// pre-define errors for supporting janeta errorFormatter
var (
...
// Account is structure of janeta account
type Account struct {
	*signers.Signer
	ID    string `json:"id"`
