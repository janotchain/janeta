...
import (
	...
	"github.com/janotchain/janeta/consensus/bcrp"
...
func isTransactionNoJtaInput(tx *types.Tx) bool {
...
func (tp *TxPool) IsDust(tx *types.Tx) bool {
	return isTransactionNoJtaInput(tx) || isTransactionZeroOutput(tx) || isInvalidBCRPTx(tx)
}
